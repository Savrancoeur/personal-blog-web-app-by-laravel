            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{url('admin/skills')}}" class="btn btn-primary float-end"><i
                    ...
                    <form action="{{url('admin/skills/'.$skill->id)}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                value="{{$skill->name ?? old('name')}}" placeholder="Enter skill name...">
                            @error('name')
                        ...
                        <div class="form-group my-3">
                            ...
                            <input type="text" name="percent"
                                ...
                                value="{{$skill->percent ?? old('percent')}}" placeholder="Enter skill percent...">
                            @error('percent')
                            <span><small class="text-danger ">{{$message}}</small></span>
                            @enderror
                        </div>
